...
require (
	...
	k8s.io/cluster-bootstrap v0.19.14
...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.19.14
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.19.14
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.19.14
