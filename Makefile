...
ROOT_PACKAGE=github.com/superedge/edgeadm
VERSION_PACKAGE=github.com/superedge/edgeadm/pkg/version
...
Options:
  ...
  PLATFORMS    The multiple platforms to build. Default is linux_amd64、linux_arm64 and linux_arm
               ...
               Example: make image.multiarch IMAGES="edgeadm" PLATFORMS="linux_amd64 linux_arm64" VERSION="v2.0.0"
               Example: make manifest.multiarch IMAGES="edgeadm" PLATFORMS="linux_amd64 linux_arm64" REGISTRY_PREFIX="superedge" VERSION="v2.0.0"
